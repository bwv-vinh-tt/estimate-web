...
#     result['new_mod'] = result['new_mod'] * 10 * DIFFICULT_NUM
    ...
    result['coding_method_level'] = py_.replace(
        result['coding_method_level'], '%', '')
    result['business_logic_level'] = 100 if result['business_logic_level'] == 'nan' else result['business_logic_level']
    result['business_logic_level'] = (
        101 - py_.parse_int(result['business_logic_level'], 10))
    result['coding_method_level'] = 100 if result['coding_method_level'] == 'nan' else result['coding_method_level']
    result['coding_method_level'] = (
        101 - py_.parse_int(result['coding_method_level'], 10))
